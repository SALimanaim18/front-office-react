      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {userTypes.map((type, index) => (
            <div
              key={index}
              className="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition-all hover:transform hover:-translate-y-2 border-t-4 border-[#b2d3e1] hover:border-[#d93f31]"
              data-aos="fade-up"
        ...
        <div className="mt-16 bg-white rounded-xl shadow-lg p-8 transform hover:scale-[1.02] transition-transform">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="p-4 group">
              <div className="text-4xl font-bold text-[#d93f31] mb-2 group-hover:animate-pulse">5,000+</div>
            ...
            <div className="p-4 border-t md:border-t-0 md:border-l md:border-r border-gray-200 group">
              <div className="text-4xl font-bold text-[#d93f31] mb-2 group-hover:animate-pulse">1,200+</div>
              <p className="text-gray-600">Dons réalisés</p>
            </div>
            <div className="p-4 border-t md:border-t-0 group">
              <div className="text-4xl font-bold text-[#d93f31] mb-2 group-hover:animate-pulse">30+</div>
