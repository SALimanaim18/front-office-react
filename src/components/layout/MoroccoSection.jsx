        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center justify-center mb-8">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#d93f31] ml-4">La transfusion sanguine au Maroc</h2>
            </div>
  
            <div className="bg-white rounded-xl p-8 shadow-lg border-t-4 border-[#d93f31] transform hover:scale-[1.01] transition-transform">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Pourtant, le pays fait face à une <span className="text-[#d93f31] font-semibold">pénurie chronique</span>,
                notamment pour les groupes sanguins rares. Il est urgent de{" "}
                <span className="text-[#d93f31] font-semibold">sensibiliser les jeunes</span>, de créer une culture du don
                régulier et d'utiliser des outils modernes pour mieux alerter et mobiliser.
              </p>
              <p className="text-gray-700 leading-relaxed font-medium">
                <span className="text-[#d93f31] font-bold">SangConnect</span> s'inscrit dans cette dynamique citoyenne en
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
                <div className="bg-gray-50 p-4 rounded-lg text-center hover:bg-[#b2d3e1]/10 transition-colors group">
                  <div className="text-2xl font-bold text-[#d93f31] group-hover:scale-110 transform transition-transform">
                    750,000
                  </div>
            ...
            <div className="mt-8 text-center">
              <button className="inline-flex items-center px-6 py-3 rounded-lg bg-[#d93f31] text-white font-medium hover:bg-[#5a0b06] transition-all shadow-md hover:shadow-lg transform hover:scale-105">
